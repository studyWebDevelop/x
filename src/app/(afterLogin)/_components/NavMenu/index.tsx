          ...
          <div className={st.navPill}>
            {segment === "home" ? (
              <>
                ...
                <div className={st.fontColor} style={{ fontWeight: "bold" }}>
                  홈
                </div>
              </>
            ) : (
              <>
                ...
                <div className={st.fontColor}>홈</div>
              </>
            )}
          </div>
        </Link>
          ...
          <div className={st.navPill}>
            {segment && ["search", "explore"].includes(segment) ? (
              <>
                ...
                <div style={{ fontWeight: "bold" }} className={st.fontColor}>
                  탐색하기
                </div>
              </>
            ) : (
              <>
                ...
                <div className={st.fontColor}>탐색하기</div>
              </>
            )}
          </div>
        </Link>
          ...
          <div className={st.navPill}>
            {segment === "messages" ? (
              ...
              <>
                ...
                <div className={st.fontColor}>쪽지</div>
              </>
            )}
          </div>
        </Link>
            ...
            <div className={st.navPill}>
              {segment === me?.user?.email ? (
                ...
                <>
                  ...
                  <div className={st.fontColor}>프로필</div>
                </>
              )}
            </div>
          </Link>
